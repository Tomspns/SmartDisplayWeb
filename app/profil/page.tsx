...
import { me, logout, updateProfile, User, MeResponse } from "@/lib/authApi";
          ...
          {!user ? (
            ...
            <>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="h-14 w-14 rounded-full bg-linear-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white text-xl font-bold">
